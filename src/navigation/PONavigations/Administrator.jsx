  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.get(
        `${apiKey}/purchase-orders?page=${page}&per_page=15&branch=${selectedBranchId}&department=${selectedDepartment}&item_group=${selectedItemGroup}&start_date=${selectedStartDate}&end_date=${selectedEndDate}&tab=3`,
        {
          headers: {
            Authorization: `Bearer ${authToken}`,
          },
